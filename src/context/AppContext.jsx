...
export const AppProvider = ({ children }) => {
  ...
  const [project, setProject] = useState(() => {
    ...
    return {
      ...
      contributors: {
        self: { name: '김연세 (나)', role: 'Frontend Developer', wordsTyped: 1240, commits: 18, status: 'active', lastActive: initialTime },
        partner1: { name: '이민수', role: 'Backend Developer', wordsTyped: 1450, commits: 24, status: 'active', lastActive: initialTime },
        partner2: { name: '박지영', role: 'UI/UX Designer', wordsTyped: 420, commits: 2, status: 'active', lastActive: initialTime },
        partner3: { name: '최동현', role: 'Backend Developer', wordsTyped: 80, commits: 0, status: 'active', lastActive: initialTime - 60000 }
      }
    };
  });
